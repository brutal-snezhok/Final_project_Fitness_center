...
public class ConnectionPoolTest {
    ...
    private static final String WORKING_URL = "jdbc:mysql://localhost:3306/mysql?useSSL=false";
   ...
   // private static final String PROPERTY_PATH = "src/main/resources/dbConfig.properties";
    ...
    @AfterMethod
    public void setDown() throws PoolFitnessException, IOException, SQLException {
